...
namespace LibreriaBoscoso.Views.Administrador
{
    public partial class ReporteVentas : Form
    {
        ...
        private async void ReporteVentas_Load(object sender, EventArgs e)
        {
            await CargarVentas();
        }
        ...
        {
            MessageBox.Show("Ya estás en el reporte de ventas.", "Información", MessageBoxButtons.OK, MessageBoxIcon.Information);
        }
